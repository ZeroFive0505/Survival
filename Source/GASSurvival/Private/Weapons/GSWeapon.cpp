...
void AGSWeapon::SetOwningCharacter(AGSSurvivor* InOwningCharacter)
{
...
void AGSWeapon::AddAbilities()
{
	...
	if (!ASC)
	{
		UE_LOG(LogTemp, Error, TEXT("%s %s Role: %d ASC is null"), *FString(__FUNCTION__), *GetName(), GET_ACTOR_ROLE_FSTRING(OwningCharacter));
		return;
	}
...
void AGSWeapon::PickUpOnTouch(AGSSurvivor* InCharacter)
{
